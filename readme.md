...
I'm **Flávia Reis**, a passionate technology enthusiast diving into the world of Full Stack Development. Currently, I'm delving into the realms of HTML, CSS, Tailwind, Bootstrap, JavaScript, React, Git, Node, Express, Sequelize, MySQL, Firebase and Git.
...
Eu sou **Flávia Reis**, uma entusiasta da tecnologia mergulhando no mundo do Desenvolvimento Full Stack. Atualmente, estou explorando os domínios de HTML, CSS, Tailwind, Bootstrap, JavaScript, React, Git, Node, Express, Sequelize, MySQL, Firebase e Git.
